...
{
    //Variables for slime following player
    ...
    public GameObject bulletLeft;
     ...
     void Start()
    {
        //variables used for following player
    ...
    void Update() //Mathf.Sqrt(); Mathf.Abs(); for square root and absolute value
    {
        ...
        {
            Instantiate(bulletUp, transform.position, transform.rotation); //Shoots Projectile Up
            Instantiate(bulletDown, transform.position, transform.rotation); //Shoots Projectile Down
            Instantiate(bulletRight, transform.position, transform.rotation); //Shoots Projectile Right
            Instantiate(bulletLeft, transform.position, transform.rotation); //Shoots Projectile Left
            Destroy(gameObject);
        }
    }
}
